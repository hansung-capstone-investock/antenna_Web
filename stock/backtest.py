...
class Backtest:
    ...
    def __init__(self, backTestInfo):
        ...
        self.sellConditionHigh = backTestInfo['sellConditionHigh']
        self.sellConditionLow = backTestInfo['sellConditionLow']
    ...
    def sellingStock(self,dailyAll_df):
        ...
        for key,value in self.haveStock.items():
            ...
            gapPercent = float(gap/boughtPrice*100)
    ...
    def dailyTesting(self,targetList):
        ...
        print(buyStockNum, self.haveStock)
